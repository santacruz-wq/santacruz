...
class BrowniesPage extends StatefulWidget {
  const BrowniesPage({super.key});

  @override
  State<BrowniesPage> createState() => _BrowniesPageState();
}

class _BrowniesPageState extends State<BrowniesPage> {
  // ================================================================
  // PRODUCTOS DE BROWNIES
  // ================================================================

  final List<Map<String, dynamic>> productosBrownies =
                ...
                children: [
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount:
                          productosBrownies.length,

                      itemBuilder: (context, index) {
                        return tarjetaProducto(
                          productosBrownies[index],
                        );
                      },
                    ),
                  ),
