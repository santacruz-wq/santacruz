...
class _CafePageState extends State<CafePage> {
  ...
  final List<Map<String, dynamic>> productosCafe =
              ...
              body: Column(
                children: [
                  ProductoHeader(
                    titulo: es ? 'Café' : 'Coffee',
                    subtitulo: es
                        ? 'Deliciosos productos con sabor a café'
                        : 'Delicious coffee-flavored products',
                  ),
